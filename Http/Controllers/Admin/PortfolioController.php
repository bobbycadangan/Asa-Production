...
class PortfolioController extends Controller
{
    ...
    public function update(Request $request, Portfolio $portfolio)
    {
        ...
        if ($request->hasFile('thumbnail')) {
            ...
            // Kalau fullsize belum pernah di-custom terpisah (masih sama dengan
            // thumbnail lama) dan tidak ada fullsize baru diupload, fullsize
            // otomatis ikut mengganti ke thumbnail baru ini.
            if (! $request->hasFile('image') && $portfolio->image === $portfolio->thumbnail) {
                $data['image'] = $data['thumbnail'];
            }
        }
