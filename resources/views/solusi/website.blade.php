...
<head>
  ...
  <title>Jasa Pembuatan Website - {{ $setting->site_title ?? 'Asa Production' }}</title>
  <meta name="description" content="{{ $page->meta_description ?? 'Jasa pembuatan website perusahaan, landing page, dan toko online oleh '.($setting->site_title ?? 'Asa Production').'.' }}">
  ...
  {{-- Stylesheet khusus halaman solusi (masthead, benefit grid, proses, dst) --}}
...
<body class="blog-body">
  ...
  {{-- ======================== MASTHEAD ======================== --}}
  {{-- Seluruh teks di bawah ini dikelola dari Admin > Jasa Website --}}
  <div class="solusi-masthead" style="background-image: linear-gradient(180deg, rgba(0, 20, 46, 0.6) 0%, rgba(0, 20, 46, 0.88) 100%), url('{{ $page->hero_background ? asset('storage/'.$page->hero_background) : asset('images/parallax.jpg') }}');">
    <div class="container">
      ...
      <div class="solusi-masthead_actions">
        ...
        <a href="{{ route('portfolio.index') }}" class="btn btn-outline" style="font-size:16px;padding:15px 26px;">Lihat Portofolio</a>
      </div>
    </div>
  </div>

  {{-- ======================== STAT STRIP ======================== --}}
  {{-- Dikelola dari Admin > Jasa Website > Kelola Statistik --}}
  @if($stats->count())
  ...
  {{-- ======================== KENAPA PILIH KAMI ======================== --}}
  {{-- Dikelola dari Admin > Jasa Website > Kelola Poin Keunggulan --}}
  @if($benefits->count())
  ...
  {{-- Dikelola dari Admin > Jasa Website > Kelola Daftar Layanan --}}
  @if($websiteServices->count())
  ...
  {{-- ======================== PROSES PENGERJAAN ======================== --}}
  {{-- Dikelola dari Admin > Jasa Website > Kelola Langkah Proses --}}
  ...
  {{-- Dikelola dari Admin > Jasa Website > Kelola Badge Teknologi --}}
  @if($techBadges->count())
  ...
  {{-- ======================== PORTOFOLIO PREVIEW ======================== --}}
  {{-- Judul dikelola dari Admin > Jasa Website; isi diambil dari menu Portofolio --}}
  ...
  <section class="solusi-section">
    ...
    <div class="center" style="text-align:center;margin-top:40px;">
      <a href="{{ route('portfolio.index') }}" class="btn btn-sm">Lihat Semua Portofolio</a>
    </div>
  </section>
  @endif

  {{-- ======================== FAQ ======================== --}}
  {{-- Dikelola dari Admin > Jasa Website > Kelola Daftar FAQ --}}
  @if($websiteFaqs->count())
  <section class="solusi-section" style="background:#f9fafc;max-width:100%;">
    <div class="solusi-section_head">
    ...
    <div class="solusi-faq-list">
      @foreach($websiteFaqs as $index => $faq)
  ...
  {{-- ======================== CTA BANNER ======================== --}}
  {{-- Dikelola dari Admin > Jasa Website --}}
  <section style="padding:0 20px;">
    <div class="solusi-cta">
      ...
      <div class="solusi-cta_actions">
        ...
        <a href="{{ route('contact') }}" class="btn btn-outline" style="font-size:16px;padding:15px 26px;">Isi Form Kontak</a>
      </div>
    </div>
  </section>
