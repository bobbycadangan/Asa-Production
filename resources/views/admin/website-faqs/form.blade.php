...
@section('content')
<form method="POST" action="{{ $item->exists ? route('admin.website-faqs.update', $item) : route('admin.website-faqs.store') }}">
  @csrf
  ...
  <div class="mt-3">
    ...
    <a href="{{ route('admin.website-faqs.index') }}" class="btn btn-outline-secondary">Batal</a>
  </div>
</form>
@endsection
