...
@section('title', 'Jasa Pembuatan Sistem Kustom')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
  <p class="text-muted mb-0">Kelola isi halaman publik <a href="{{ route('solusi.custom-system') }}" target="_blank" rel="noopener">/solusi/jasa-pembuatan-sistem-kustom</a>.</p>
  <a href="{{ route('solusi.custom-system') }}" target="_blank" rel="noopener" class="btn btn-sm btn-outline-secondary"><i class="bi bi-box-arrow-up-right me-1"></i>Lihat Halaman</a>
</div>

<form method="POST" action="{{ route('admin.custom-system.update') }}" enctype="multipart/form-data">
  @csrf
  @method('PUT')
  ...
  <div class="card shadow-sm mb-3">
    ...
    <div class="card-body row g-3">
      ...
      <div class="col-md-6">
        ...
        <div class="mb-2">
          <img src="{{ $page->hero_background ? asset('storage/'.$page->hero_background) : asset('images/parallax2.jpg') }}" class="thumb-preview">
        </div>
  ...
  <div class="card shadow-sm mb-3">
    <div class="card-header bg-white fw-semibold d-flex justify-content-between align-items-center">
      ...
      <a href="{{ route('admin.custom-system-stats.index') }}" class="btn btn-sm btn-dark">Kelola Statistik ({{ $counts['stats'] }})</a>
    </div>
    <div class="card-body text-muted small">Contoh: "30+ Sistem Dibangun". Dikelola terpisah karena jumlahnya bisa ditambah/dikurangi.</div>
  </div>
  ...
  <div class="card shadow-sm mb-3">
    ...
    <div class="card-body row g-3">
      ...
      <div class="col-12">
        <a href="{{ route('admin.custom-system-benefits.index') }}" class="btn btn-sm btn-dark">Kelola Poin Keunggulan ({{ $counts['benefits'] }})</a>
      </div>
    </div>
  </div>
  ...
  <div class="card shadow-sm mb-3">
    ...
    <div class="card-body row g-3">
      ...
      <div class="col-12">
        <a href="{{ route('admin.custom-system-services.index') }}" class="btn btn-sm btn-dark">Kelola Daftar Layanan ({{ $counts['services'] }})</a>
      </div>
    </div>
  </div>

  <div class="card shadow-sm mb-3">
    <div class="card-header bg-white fw-semibold">Proses Pengembangan</div>
    <div class="card-body row g-3">
      <div class="col-md-4">
        <label class="form-label">Label Kecil (Eyebrow)</label>
      ...
      <div class="col-12">
        <a href="{{ route('admin.custom-system-process-steps.index') }}" class="btn btn-sm btn-dark">Kelola Langkah Proses ({{ $counts['process_steps'] }})</a>
      </div>
    </div>
  </div>
  ...
  <div class="card shadow-sm mb-3">
    ...
    <div class="card-body row g-3">
      ...
      <div class="col-12">
        <a href="{{ route('admin.custom-system-tech-badges.index') }}" class="btn btn-sm btn-dark">Kelola Badge Teknologi ({{ $counts['tech_badges'] }})</a>
      </div>
    </div>
  </div>
  ...
  <div class="card shadow-sm mb-3">
    ...
    <div class="card-body row g-3">
      ...
      <div class="col-12">
        <div class="form-text">Contoh sistem yang ditampilkan diambil otomatis dari menu <a href="{{ route('admin.portfolio.index') }}">Portofolio</a> (kategori yang mengandung kata "sistem"/"system"/"kustom" diprioritaskan).</div>
      </div>
    </div>
  </div>
  ...
  <div class="card shadow-sm mb-3">
    ...
    <div class="card-body row g-3">
      ...
      <div class="col-12">
        <a href="{{ route('admin.custom-system-faqs.index') }}" class="btn btn-sm btn-dark">Kelola Daftar FAQ ({{ $counts['faqs'] }})</a>
      </div>
    </div>
  </div>
