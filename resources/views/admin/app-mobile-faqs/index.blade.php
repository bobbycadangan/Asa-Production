...
@section('title', 'FAQ - Jasa App Mobile')
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="{{ route('admin.app-mobile-faqs.create') }}" class="btn btn-dark"><i class="bi bi-plus-lg me-1"></i>Tambah FAQ</a>
</div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-end pe-3">
            <a href="{{ route('admin.app-mobile-faqs.edit', $item) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
            <form action="{{ route('admin.app-mobile-faqs.destroy', $item) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus FAQ ini?');">
              @csrf @method('DELETE')
