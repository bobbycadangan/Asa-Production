...
@section('title', 'Proses Pengerjaan - Jasa Website')
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="{{ route('admin.website-process-steps.create') }}" class="btn btn-dark"><i class="bi bi-plus-lg me-1"></i>Tambah Langkah</a>
</div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-end pe-3">
            <a href="{{ route('admin.website-process-steps.edit', $item) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
            <form action="{{ route('admin.website-process-steps.destroy', $item) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus langkah ini?');">
              @csrf @method('DELETE')
