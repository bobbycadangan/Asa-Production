...
@section('title', 'Kenapa Pilih Kami - Jasa App Mobile')
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="{{ route('admin.app-mobile-benefits.create') }}" class="btn btn-dark"><i class="bi bi-plus-lg me-1"></i>Tambah Poin</a>
</div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-end pe-3">
            <a href="{{ route('admin.app-mobile-benefits.edit', $item) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
            <form action="{{ route('admin.app-mobile-benefits.destroy', $item) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus poin ini?');">
              @csrf @method('DELETE')
