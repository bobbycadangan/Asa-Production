...
return new class extends Migration
{
     ...
     * "Jasa Pembuatan Sistem Kustom" (masthead, judul tiap section, CTA, dst)
     * supaya bisa diedit lewat halaman admin tanpa mengubah kode.
     */
    public function up(): void
    {
        Schema::create('custom_system_pages', function (Blueprint $table) {
            $table->id();

            // Masthead
            $table->string('hero_eyebrow')->default('Solusi Kami');
            $table->string('hero_title')->default('Jasa Pembuatan Sistem Kustom Sesuai Kebutuhan Bisnis Anda');
            $table->text('hero_description')->nullable();
            $table->string('hero_background')->nullable();

            // Pesan default yang dikirim ke WhatsApp (dipakai di masthead & CTA banner)
            $table->string('whatsapp_message')->default('Halo, saya ingin konsultasi pembuatan sistem kustom');

            // Section: Kenapa Pilih Kami
            $table->string('why_us_eyebrow')->default('Kenapa Pilih Kami');
            $table->string('why_us_title')->default('Partner Terpercaya untuk Sistem Bisnis Anda');
            ...
            $table->string('process_title')->default('Proses Pengembangan Sistem Kami');
            ...
            $table->string('portfolio_title')->default('Contoh Sistem yang Pernah Kami Buat');
            ...
            // Section: CTA banner
            $table->string('cta_title')->default('Siap Membuat Sistem Kustom Anda?');
    ...
    {
        Schema::dropIfExists('custom_system_pages');
    }
};
