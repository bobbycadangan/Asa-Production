...
@section('content')
<form method="POST" action="{{ $item->exists ? route('admin.custom-system-faqs.update', $item) : route('admin.custom-system-faqs.store') }}">
  @csrf
  ...
  <div class="mt-3">
    ...
    <a href="{{ route('admin.custom-system-faqs.index') }}" class="btn btn-outline-secondary">Batal</a>
  </div>
</form>
@endsection
