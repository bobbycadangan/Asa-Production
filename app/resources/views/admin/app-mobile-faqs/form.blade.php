...
@section('content')
<form method="POST" action="{{ $item->exists ? route('admin.app-mobile-faqs.update', $item) : route('admin.app-mobile-faqs.store') }}">
  @csrf
  ...
  <div class="mt-3">
    ...
    <a href="{{ route('admin.app-mobile-faqs.index') }}" class="btn btn-outline-secondary">Batal</a>
  </div>
</form>
@endsection
