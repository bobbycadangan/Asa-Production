...
@section('content')
<form method="POST" action="{{ $item->exists ? route('admin.website-process-steps.update', $item) : route('admin.website-process-steps.store') }}">
  @csrf
  ...
  <div class="mt-3">
    ...
    <a href="{{ route('admin.website-process-steps.index') }}" class="btn btn-outline-secondary">Batal</a>
  </div>
</form>
@endsection
