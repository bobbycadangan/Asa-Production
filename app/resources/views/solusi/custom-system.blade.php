...
<head>
  ...
  <title>Jasa Pembuatan Sistem Kustom - {{ $setting->site_title ?? 'Asa Production' }}</title>
  <meta name="description" content="{{ $page->meta_description ?? 'Jasa pembuatan sistem kustom (aplikasi web, dashboard, sistem internal) sesuai kebutuhan bisnis oleh '.($setting->site_title ?? 'Asa Production').'.' }}">
...
<body class="blog-body">
  ...
  {{-- ======================== MASTHEAD ======================== --}}
  {{-- Seluruh teks di bawah ini dikelola dari Admin > Jasa Sistem Kustom --}}
  ...
  {{-- ======================== STAT STRIP ======================== --}}
  {{-- Dikelola dari Admin > Jasa Sistem Kustom > Kelola Statistik --}}
  @if($stats->count())
  ...
  {{-- ======================== KENAPA PILIH KAMI ======================== --}}
  {{-- Dikelola dari Admin > Jasa Sistem Kustom > Kelola Poin Keunggulan --}}
  @if($benefits->count())
  ...
  {{-- Dikelola dari Admin > Jasa Sistem Kustom > Kelola Daftar Layanan --}}
  @if($systemServices->count())
  <section class="solusi-section" style="background:#f9fafc;max-width:100%;">
    ...
    <div class="service-grid" style="max-width:1140px;margin:0 auto;">
      @foreach($systemServices as $item)
  ...
  {{-- ======================== PROSES PENGEMBANGAN ======================== --}}
  {{-- Dikelola dari Admin > Jasa Sistem Kustom > Kelola Langkah Proses --}}
  ...
  {{-- Dikelola dari Admin > Jasa Sistem Kustom > Kelola Badge Teknologi --}}
  @if($techBadges->count())
  ...
  {{-- ======================== PORTOFOLIO PREVIEW ======================== --}}
  {{-- Judul dikelola dari Admin > Jasa Sistem Kustom; isi diambil dari menu Portofolio --}}
  ...
  {{-- ======================== FAQ ======================== --}}
  {{-- Dikelola dari Admin > Jasa Sistem Kustom > Kelola Daftar FAQ --}}
  @if($systemFaqs->count())
  <section class="solusi-section" style="background:#f9fafc;max-width:100%;">
    <div class="solusi-section_head">
    ...
    <div class="solusi-faq-list">
      @foreach($systemFaqs as $index => $faq)
  ...
  {{-- ======================== CTA BANNER ======================== --}}
  {{-- Dikelola dari Admin > Jasa Sistem Kustom --}}
